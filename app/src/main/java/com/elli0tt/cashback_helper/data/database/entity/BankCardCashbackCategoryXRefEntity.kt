...
import com.elli0tt.cashback_helper.data.database.entity.BankCardCashbackCategoryXRefEntity.Companion.TABLE_NAME

@Entity(
    tableName = TABLE_NAME,
    primaryKeys = [BankCardEntity.COLUMN_NAME, CashbackCategoryEntity.COLUMN_NAME]
)
data class BankCardCashbackCategoryXRefEntity(
    ...
    companion object {
        const val TABLE_NAME = "bank_cards_cashback_categories_x_ref_table"
