...
class DebugAddMockBankCardsWithCashbackCategoriesUseCaseImpl(
    ...
    private fun generateMockCashbackCategories(): List<BankCardWithCashbackCategories.CashbackCategory> {
        val cashbackCategoriesCount = 5
        val resultList = mutableListOf<BankCardWithCashbackCategories.CashbackCategory>()
        repeat(cashbackCategoriesCount) {
            resultList += BankCardWithCashbackCategories.CashbackCategory(
